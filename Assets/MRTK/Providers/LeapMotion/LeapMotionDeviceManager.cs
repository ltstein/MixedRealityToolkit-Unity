        ...
        public override void Enable()
        {
            ...
            if (leapControllerOrientation == LeapControllerOrientation.Headset)
            {
                ...
                if (System.IO.File.Exists(path))
                {
                    ...
                    Vector3 leapposition = new Vector3(headset.leapTrackerOdometryOrigin.position_x, 
                        headset.leapTrackerOdometryOrigin.position_y, 
                        headset.leapTrackerOdometryOrigin.position_z);

                    Quaternion leaprotation = new Quaternion(headset.leapTrackerOdometryOrigin.rotation_x, 
                        headset.leapTrackerOdometryOrigin.rotation_y, 
                        headset.leapTrackerOdometryOrigin.rotation_z, 
                        headset.leapTrackerOdometryOrigin.rotation_w);
